...
HD_PWD='C:/Users/NR/OneDrive - University of Huddersfield/PhD third year/fully tested code versions/FPGA codes/cosine_sim_crosssection_300_15-03-2021/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cosine_sim.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cosine_sim.tcl
