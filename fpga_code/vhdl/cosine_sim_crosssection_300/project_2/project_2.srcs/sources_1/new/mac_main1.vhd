...
MAC1: mac_3x1_array port map (clk,S1_inp,S2_inp,MAC1_OUT);
MAC2: mac_3x1_array port map (clk,S1_inp,S1_inp,MAC2_OUT);
MAC3: mac_3x1_array port map (clk,S2_inp,S2_inp,MAC3_OUT);
