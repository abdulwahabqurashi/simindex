...
HD_PWD='D:/Mac array 161120/jaccard_sim_crosssection_300_28-03-21/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mac_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mac_main.tcl
